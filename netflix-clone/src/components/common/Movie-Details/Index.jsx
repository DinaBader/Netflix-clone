...
function MovieDetails({ id }) {
  ...
  const fetchInfo = () => {
    fetch(
      `https://api.themoviedb.org/3/movie/${id}?api_key=324752feff8b4c90538fe9c50b9e9ad5`
    )
      .then((res) => res.json())
      .then((movieData) => {
        setData(movieData);
  ...
  const fetchCast = () => {
    fetch(
      `https://api.themoviedb.org/3/movie/${id}/credits?api_key=324752feff8b4c90538fe9c50b9e9ad5`
    )
      .then((res) => res.json())
      .then((castData) => {
